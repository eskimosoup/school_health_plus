...
Gem::Specification.new do |s|
  ...
  s.date = %q{2011-12-28 00:00:00.000000000Z}
  s.description = %q{}
  s.email = ["probablycorey@gmail.com", "hcatlin@gmail.com", "peter@nulayer.com"]
  s.files = ["test/command_builder_test.rb", "test/files/actually_a_gif.jpg", "test/files/animation.gif", "test/files/composited.jpg", "test/files/leaves (spaced).tiff", "test/files/not_an_image.php", "test/files/png.png", "test/files/simple-minus.gif", "test/files/simple.gif", "test/files/trogdor.jpg", "test/files/trogdor_capitalized.JPG", "test/image_test.rb", "test/leaves (spaced).tiff", "test/test_helper.rb", "test/trogdor_capitalized.JPG"]
